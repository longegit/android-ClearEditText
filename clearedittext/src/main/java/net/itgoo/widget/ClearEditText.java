...
import net.itgoo.clearedittext.R;
...
public class ClearEditText extends EditText {
     ...
     * 默认的清除按钮图标资源
     */
    private static final int ICON_CLEAR_DEFAULT = R.mipmap.btn_edit_clear_normal;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 获取清除按钮图标资源
        int iconClear =
                typedArray.getResourceId(R.styleable.ClearEditText_clearIcon, ICON_CLEAR_DEFAULT);
